...
public class XN623041 extends AProcessor {
    ...
    public Object doBusiness() throws BizException {
        certificationAO.submitInfoOccupation(req);
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN623041Req.class);
        StringValidater.validateBlank(req.getUserId(), req.getOccupation(),
            req.getIncome(), req.getCompany(), req.getProvinceCity(),
            req.getAddress());
    }
}
