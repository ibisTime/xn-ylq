...
import com.cdkj.ylq.dto.req.XN623046Req;
...
public class XN623046 extends AProcessor {
    ...
    public Object doBusiness() throws BizException {
        return certificationAO.doZhimaQuery(req.getUserId(), req.getBizNo());
    }
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN623046Req.class);
