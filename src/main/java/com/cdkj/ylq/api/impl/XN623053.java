...
import com.cdkj.ylq.dto.req.XN623053Req;
...
public class XN623053 extends AProcessor {
    ...
    public Object doBusiness() throws BizException {
        certificationAO.doAddressBookVerify(req.getUserId(),
            req.getAddressBookList());
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN623053Req.class);
