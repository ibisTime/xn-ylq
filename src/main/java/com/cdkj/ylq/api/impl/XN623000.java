 ...
 * @history:
 */
public class XN623000 extends AProcessor {

    private IProductAO productAO = SpringContextHolder
        .getBean(IProductAO.class);

    private XN623000Req req = null;
    ...
    public void doCheck(String inputparams) throws ParaException {
        ...
        StringValidater.validateBlank(req.getName(), req.getLevel(),
            req.getAmount(), req.getDuration(), req.getRate1(), req.getRate2(),
            req.getLxAmount(), req.getXsAmount(), req.getGlAmount(),
            req.getFwAmount(), req.getUpdater());
    }
