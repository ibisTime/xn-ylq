...
import com.cdkj.ylq.dto.req.XN623165Req;
...
public class XN623165 extends AProcessor {
    ...
    public Object doBusiness() throws BizException {
        ...
        return noticerAO.queryNoticerPage(start, limit, condition);
    }

    @Override
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN623165Req.class);
