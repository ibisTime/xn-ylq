...
import com.cdkj.ylq.dto.req.XN623047Req;
...
public class XN623047 extends AProcessor {
    ...
    public Object doBusiness() throws BizException {
        return certificationAO.doZhimaCreditScoreGet(req.getUserId());
    }
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN623047Req.class);
