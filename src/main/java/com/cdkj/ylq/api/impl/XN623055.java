...
import com.cdkj.ylq.dto.req.XN623055Req;
...
public class XN623055 extends AProcessor {
    ...
    public Object doBusiness() throws BizException {
        certificationAO.doTongDunPreLoanReload(req.getUserId());
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN623055Req.class);
