...
import com.cdkj.ylq.dto.req.XN623092Req;
...
public class XN623092 extends AProcessor {
    ...
    public Object doBusiness() throws BizException {
        return contractAO.preview(req.getUserId(),
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN623092Req.class);
