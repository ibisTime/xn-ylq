...
public class ApplyDAOImpl extends AMybatisTemplate implements IApplyDAO {
	...
	public Apply select(Apply condition) {
		return super.select(NAMESPACE.concat("select_apply"), condition,Apply.class);
	}


	@Override
	public Long selectTotalCount(Apply condition) {
		return super.selectTotalCount(NAMESPACE.concat("select_apply_count"),condition);
	}


	@Override
	public List<Apply> selectList(Apply condition) {
		return super.selectList(NAMESPACE.concat("select_apply"), condition,Apply.class);
	}


	@Override
	public List<Apply> selectList(Apply condition, int start, int count) {
		return super.selectList(NAMESPACE.concat("select_apply"), start, count,condition, Apply.class);
	}
